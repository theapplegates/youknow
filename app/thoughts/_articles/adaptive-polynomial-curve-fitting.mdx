...
Last month I worked on a side project internally during Vercel’s Design Your Friday[^first], to improve the data visualization of our Analytics[^2] charts. Previously, all the data points were visualized by simply connecting them as a line:
