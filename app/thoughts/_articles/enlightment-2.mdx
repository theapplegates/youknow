...
This is also called the [Probe Effect](https://en.wikipedia.org/wiki/Probe_effect). The act of measuring changes the thing being measured. Or [Heisenbugs](https://en.wikipedia.org/wiki/Heisenbug).
