...
I’ve been contributing to [Next.js](https://nextjs.org) as a core maintainer since 2020. I led the development of Streaming SSR, Edge Runtime, React Server Components, Server Actions and other major architectural changes and improvements in Next.js.
