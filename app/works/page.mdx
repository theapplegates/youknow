...
Over the past years, I'm lucky to be contributing to some of the most impactful projects in the Web, React ecosystem and open source community.
...
I’ve been contributing to [Next.js](https://nextjs.org) as a core maintainer since 2020. I closely collaborated with the React core team, led the development of Streaming SSR, Edge Runtime, React Server Components, Server Actions and other major architectural changes and improvements in Next.js.

It is always challenging to work on a large-scale project like Next.js. Keeping the balance between features, performance and simplicity is really an art, and I learned a lot from the process.
...
I also have fun building random UI experiments and tools. Here’s an incomplete list:
